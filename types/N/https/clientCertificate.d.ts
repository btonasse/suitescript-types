...
declare module "https/clientCertificate" {
    import type { ClientResponse } from "N/https";
    ...
    const deleteFunc: DeleteMethod; // Workaround for the fact that "delete" is a JS keyword.
