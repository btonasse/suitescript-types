declare global {
     ...
     * @constructor
     */
    function nlobjCredentialBuilder(request: string, domain: string): NLObjCredentialBuilder;
     ...
     * @constructor
     */
    function nlobjError(): NLObjError;
     ...
     */
    function nlobjSearchColumn(name: string, join?: string, summary?: string): void;
     ...
     */
    function nlapiAddDays(d: Date, days: number): Date;
    /**
     ...
     */
    function nlapiAddMonths(d: Date, months: number): Date;
    /**
     ...
     * @param {string} type Sublist name.
     */
    function nlapiCancelLineItem(type: string): void;
    /**
     * Save changes made on the currently selected line to the sublist.
     *
     * @param {string} type Sublist name.
     */
    function nlapiCommitLineItem(type: string): void;
    /**
     ...
     */
    function nlapiCopyRecord(type: string, id: number | string, initializeValues?: Object): NLObjRecord;
    /**
     ...
     */
    function nlapiCreateAssistant(title: string, hideHeader?: boolean): NLObjAssistant;
    /**
     ...
     */
    function nlapiCreateCSVImport(): NLObjCSVImport;
    /**
     ...
     * @param {string} 	fldnam sublist field name
     */
    function nlapiCreateCurrentLineItemSubrecord(type: string, fldnam: string): NLObjSubrecord;
    /**
     ...
     */
    function nlapiCreateEmailMerger(templateId: number): NLObjEmailMerger;
    /**
     ...
     */
    function nlapiCreateError(code: string, details: string, suppressEmail?: boolean): NLObjError;
    /**
     ...
     */
    function nlapiCreateFile(name: string, type: string, contents: string): NLObjFile;
    /**
     ...
     * @param {boolean} hideHeader true to hide the page header (false by default)
     */
    function nlapiCreateForm(title: string, hideHeader?: boolean): NLObjForm;
    /**
     ...
     * @param {boolean} hideHeader true to hide the page header (false by default)
     */
    function nlapiCreateList(title: string, hideHeader?: boolean): NLObjList;
    /**
     * Instantiate a new nlobjRecord object containing all the default field data for that record type.
     * @param {string} type The record type name.
     * @param {Object} initializeValues Contains an array of name/value pairs of defaults to be used during record initialization.
     */
    function nlapiCreateRecord(type: string, initializeValues?: Object): NLObjRecord;
    /**
     * Creates an instance of a report definition object.
     */
    function nlapiCreateReportDefinition(): NLObjReportDefinition;
    /**
     * Creates an nlobjReportForm object to render the report definition.
     *
     * @param {string} title The title of the form
     */
    function nlapiCreateReportForm(title: string): NLObjReportForm;
    /**
     ...
     */
    function nlapiCreateSubrecord(fldnam: string): NLObjSubrecord;
    /**
     * Create a template renderer used to generate various outputs based on a template.
     * @restriction Server SuiteScript only
     * @governance 10 units
     */
    function nlapiCreateTemplateRenderer(): NLObjTemplateRenderer;
    /**
     ...
     */
    function nlapiDateToString(d: Date, formattype?: string): string;
    /**
     ...
     */
    function nlapiDeleteFile(id: number): number;
    /**
     * Delete a record from the system.
     * @param {string} type The record type name.
     * @param {number|string} id The internal ID of the record to delete.
     */
    function nlapiDeleteRecord(type: string, id: number | string): void;
    /**
     ...
     */
    function nlapiDetachRecord(type1: string, id1: number, type2: string, id2: number, properties?: Object): void;
    /**
     ...
     */
    function nlapiDisableField(fldnam: string, val: boolean): void;
    /**
     ...
     * @param {boolean} val If set to true, the field is disabled; if set to false, it is enabled
     */
    function nlapiDisableLineItemField(type: string, fldnam: string, val: boolean): void;
    /**
     ...
     * @param {string} 	fldnam sublist field name
     */
    function nlapiEditCurrentLineItemSubrecord(type: string, fldnam: string): NLObjSubrecord;
    /**
     * Edit a subrecord on body field on the current record on a page.
     * @restriction supported in client and user event scripts only.
     * @param {string} 	fldnam body field name
     */
    function nlapiEditSubrecord(fldnam: string): NLObjSubrecord;
    /**
     * Encrypt a String using a SHA-1 hash function.
     *
     * @param {string} s String to encrypt.
     */
    function nlapiEncrypt(s: string): string;
    /**
     * Escape a String for use in an XML document.
     *
     * @param {string} text String to escape
     */
    function nlapiEscapeXML(text: string): string;
    /**
     ...
     */
    function nlapiFindLineItemMatrixValue(type: string, fldnam: string, column: number, val: string): number;
    /**
     ...
     */
    function nlapiFindLineItemValue(type: string, fldnam: string, val: string): number;
    /**
     ...
     */
    function nlapiFormatCurrency(str: string | number): string;
    /**
     * Return context information about the current user/script.
     */
    function nlapiGetContext(): NLObjContext;
    /**
     ...
     */
    function nlapiGetCurrentLineItemDateTimeValue(type: string, fldnam: string, timezone?: string): string;
    /**
     * Return the line number for the currently selected line.
     *
     * @param {string} type Sublist name
     */
    function nlapiGetCurrentLineItemIndex(type: string): number;
    /**
     ...
     * @param {string} fldnam Sublist field name
     */
    function nlapiGetCurrentLineItemText(type: string, fldnam: string): string;
    /**
     * Return the value of a field on the currently selected line.
     *
     * @param {string} type Sublist name
     * @param {string} fldnam Sublist field name
     */
    function nlapiGetCurrentLineItemValue(type: string, fldnam: string): string;
    /**
     ...
     */
    function nlapiGetCurrentLineItemValues(type: string, fldnam: string): string[];
    /**
     * Return the internal ID for the current user's department.
     */
    function nlapiGetDepartment(): number;
    /**
     ...
     * @param {string} 	timezone
     */
    function nlapiGetLineItemDateTimeValue(type: string, fldnam: string, linenum: number, timezone?: string): string;
    /**
     ...
     * @param {string} type Sublist name
     */
    function nlapiGetLineItemCount(type: string): number;
    /**
     ...
     */
    function nlapiGetLineItemField(type: string, fldnam: string, linenum?: number): NLObjField;
    /**
     ...
     * @param {number} column Matrix column index (1-based).
     */
    function nlapiGetLineItemMatrixField(type: string, fldnam: string, linenum: number, column: number): NLObjField;
    /**
     ...
     * @param {string}  value
     */
    function nlapiGetLineItemMatrixValue(
        type: string,
        fldnam: string,
        linenum: number,
        column: number,
     ...
     * @param {int} 	linenum Line number (1-based)
     */
    function nlapiGetLineItemText(type: string, fldnam: string, linenum: number): string;
    /**
     * Return the value of a sublist field on the current record on a page.
     * @restriction supported in client and user event scripts only.
     * @param {string} 	type Sublist name
     ...
     * @param {number} 	linenum Line number (1-based)
     */
    function nlapiGetLineItemValue(type: string, fldnam: string, linenum: number): string;
    /**
     ...
     */
    function nlapiGetLineItemValues(type: string, fldnam: string, linenum: number): string[];
    /**
     * Return the internal ID for the current user's location.
     */
    function nlapiGetLocation(): number;
    /**
     ...
     */
    function nlapiGetLogin(): NLObjLogin;
    /**
     * Return the number of columns for a matrix field.
     *
     * @param {string} type Sublist name
     * @param {string} fldnam Matrix field name
     */
    function nlapiGetMatrixCount(type: string, fldnam: string): number;
    /**
     ...
     * @param {number} 	column Matrix field column index (1-based).
     */
    function nlapiGetMatrixField(type: string, fldnam: string, column: number): NLObjField;
    /**
     * Get the value of a matrix header field
     * @param {string} 	type Sublist name.
     * @param {string} 	fldnam Sublist field name.
     * @param {number} 	column Matrix column index (1-based).
     */
    function nlapiGetMatrixValue(type: string, fldnam: string, column: number): string;
    /**
     ...
     */
    function nlapiGetNewRecord(): NLObjRecord;
    /**
     ...
     */
    function nlapiGetRole(): number;
    /**
     * Return the internal ID for the current user's subsidiary.
     */
    function nlapiGetSubsidiary(): number;
    /**
     ...
     */
    function nlapiInitiateWorkflow(recordtype: string, id: number, workflowId: string | number): number;
    /**
     * Initiates a workflow on-demand and returns the workflow instance ID for the workflow-record combination.
     * @governance 20 units
     *
     ...
     */
    function nlapiInitiateWorkflowAsync(
        recordtype: string,
        id: number,
     ...
     */
    function nlapiInsertLineItem(type: string, line?: number): void;
    /**
     ...
     */
    function nlapiInsertLineItemOption(
        type: string,
        fldnam: string,
        value: string,
        text: string,
     ...
     * @param {boolean} selected If true then option will be selected by default
     */
    function nlapiInsertSelectOption(fldnam: string, value: string, text: string, selected?: boolean): void;
    /**
     ...
     * @param {string} type Sublist name
     */
    function nlapiIsLineItemChanged(type: string): boolean;
    /**
     ...
     * @param {string} type
     */
    function nlapiLoadConfiguration(type: string): NLObjConfiguration;
    /**
     ...
     */
    function nlapiLoadFile(id: string | number): NLObjFile;
    /**
     ...
     */
    function nlapiLoadRecord(type: string, id: number | string, initializeValues?: any): NLObjRecord;
    /**
     ...
     */
    function nlapiLoadSearch(type: string, id: string): NLObjSearch;
    /**
     ...
     */
    function nlapiOutboundSSO(ssoAppKey: string): string;
    /**
     ...
     */
    function nlapiPrintRecord(type: string, id: number, format?: string, properties?: Object): NLObjFile;
    /**
     ...
     * @param {string} type Sublist name
     */
    function nlapiRefreshLineItems(type: string): void;
    /**
     * Causes a FORM type nlobjPortlet to immediately reload.
     */
    function nlapiRefreshPortlet(): void;
    /**
     ...
     * @param {string} 	fldnam sublist field name
     */
    function nlapiRemoveCurrentLineItemSubrecord(type: string, fldnam: string): void;
    /**
     ...
     */
    function nlapiRemoveLineItem(type: string, line?: number): void;
    /**
     ...
     */
    function nlapiRemoveLineItemOption(type: string, fldnam: string, value: string): void;
    /**
     ...
     */
    function nlapiRemoveSelectOption(fldnam: string, value: string): void;
    /**
     * Remove a subrecord on body field on the current record on a page.
     * @restriction supported in client and user event scripts only.
     * @param {string} 	fldnam body field name
     */
    function nlapiRemoveSubrecord(fldnam: string): void;
    /**
     ...
     * @param {string} method HTTP method: GET, POST, PUT, DELETE, etc.
     */
    function nlapiRequestURLWithCredentials(
        credentials: string[],
        url: string,
        postData: string | Object,
        headers: Object,
     ...
     */
    function nlapiResizePortlet(): void;
    /**
     ...
     */
    function nlapiResolveURL(type: string, subtype: string, id?: string, pageMode?: string | boolean): string;
    /**
     ...
     */
    function nlapiScheduleScript(script: string | number, deployment?: string | number, parameters?: Object): string;
    /**
     ...
     */
    function nlapiSearchDuplicate(type: string, fields?: string[], id?: number): NLObjSearchResult[];
    /**
     * Perform a global record search across the system.
     * @param {string} keywords Global search keywords string or expression.
     */
    function nlapiSearchGlobal(keywords: string): NLObjSearchResult[];
    /**
     ...
     */
    function nlapiSelectLineItem(type: string, linenum: number): void;
    /**
     ...
     * @param {string} type Sublist name
     */
    function nlapiSelectNewLineItem(type: string): void;
    /**
     ...
     */
    function nlapiSelectNode(node: Node, xpath: string): Node;
    /**
     ...
     * @param {string} 	xpath string containing XPath expression.
     */
    function nlapiSelectNodes(node: Node, xpath: string): Node[];
    /**
     ...
     * @param {string} xpath String containing XPath expression.
     */
    function nlapiSelectValue(node: Node, xpath: string): string;
    /**
     ...
     * @param {string} xpath String containing XPath expression.
     */
    function nlapiSelectValues(node: Node, xpath: string): string[];
    /**
     ...
     */
    function nlapiSendCampaignEmail(campaignEventId: number, recipientId: number): number;
    /**
     ...
     * @param {string} timezone Timezone
     */
    function nlapiSetCurrentLineItemDateTimeValue(type: string, fldnam: string, value: string, timezone?: string): void;
    /**
     ...
     * @param {boolean} synchronous If true then sourcing and field change execution happens synchronously (defaults to false).
     */
    function nlapiSetCurrentLineItemText(
        type: string,
        fldnam: string,
        txt: string,
        fireFieldChanged?: boolean,
     ...
     * @param {boolean} synchronous If true then sourcing and field change execution happens synchronously (defaults to false).
     */
    function nlapiSetCurrentLineItemValue(
        type: string,
        fldnam: string,
        value: string | number,
        fireFieldChanged?: boolean,
     ...
     * @param {boolean} synchronous If true then sourcing and field change execution happens synchronously (defaults to false).
     */
    function nlapiSetCurrentLineItemValues(
        type: string,
        fldnam: string,
        values: string[],
        fireFieldChanged?: boolean,
     ...
     * @param {string|number} [timeZone] One of values (string) or keys (int) from the Olson Values table.
     */
    function nlapiSetDateTimeValue(fieldId: string, value: string, timeZone?: string | number): void;
    /**
     * Set whether or not a field is displayed.  This function is not documented but still works as of 2017.1.
     * @param fieldId
     * @param show
     */
    function nlapiSetFieldDisplay(fieldId: string, show: boolean): void;
    /**
     ...
     * @param {boolean} synchronous If true then sourcing and field change execution happens synchronously (defaults to false).
     */
    function nlapiSetFieldText(fldnam: string, txt: string, fireFieldChanged?: boolean, synchronous?: boolean): void;
    /**
     ...
     * @param {string}  timezone Timezone
     */
    function nlapiSetLineItemDateTimeValue(
        type: string,
        fldnam: string,
        linenum: number,
        datetime: string,
     ...
     */
    function nlapiSetLineItemDisabled(type: string, fldnam: string, val: boolean, linenum?: number): void;
    /**
     * Set the value of a sublist field on the current record on a page.
     * @restriction supported in client and user event scripts only.
     * @param {string} 	type Sublist name
     ...
     */
    function nlapiSetLineItemValue(type: string, fldnam: string, linenum: number, value: string | number): void;
    /**
     * Set the value of a matrix header field.
     * @restriction synchronous arg is only supported in client SuiteScript
     *
     ...
     */
    function nlapiSetRecoveryPoint(): Object;
    /**
     *
     * @param {string} type Type specifier for URL: suitelet|tasklink|record|mediaitem
     * @param {string} subtype Subtype specifier for URL (corresponding to type): scriptid|taskid|recordtype|mediaid
     ...
     */
    function nlapiStringToDate(str: string, format?: string): Date;
    /**
     ...
     */
    function nlapiStringToXML(str: string): XMLDocument;
    /**
     ...
     */
    function nlapiSubmitConfiguration(setup: NLObjConfiguration): void;
    /**
     * Submits a CSV import job to asynchronously import record data into NetSuite.
     *
     * @param {NLObjCSVImport} csvImport
     */
    function nlapiSubmitCSVImport(csvImport: NLObjCSVImport): string;
    /**
     ...
     */
    function nlapiSubmitFile(file: NLObjFile): number;
    /**
     ...
     */
    function nlapiSubmitRecord(record: NLObjRecord, doSourcing?: boolean, ignoreMandatoryFields?: boolean): string;
    /**
     ...
     */
    function nlapiValidateXML(xmlDocument: XMLDocument, schemaDocument: XMLDocument, schemaFolderId: string): void;
    /**
     ...
     * @param {string} 	fldnam sublist field name
     */
    function nlapiViewCurrentLineItemSubrecord(type: string, fldnam: string): NLObjSubrecord;
    /**
     * View a subrecord on a sublist field on the current record on a page.
     * @restriction supported in client and user event scripts only.
     * @param {string} type sublist name
     ...
     * @param {number} linenum
     */
    function nlapiViewLineItemSubrecord(type: string, fldnam: string, linenum: number): NLObjSubrecord;
    /**
     * view a subrecord on body field on the current record on a page.
     * @restriction supported in client and user event scripts only.
     * @param {string} 	fldname Body field name.
     */
    function nlapiViewSubrecord(fldname: string): NLObjSubrecord;
    /**
     ...
     */
    function nlapiVoidTransaction(type: string, id: string): string;
    /**
     ...
     */
    function nlapiXMLToPDF(input: string): NLObjFile;
    /**
     ...
     */
    function nlapiXMLToString(xml: XMLDocument): string;
    /**
     * Creates a recovery point and then reschedules the script.
     */
    function nlapiYieldScript(): Object;
    /**
     ...
     */
    function NLDoMainFormButtonAction(name: string, arg2: boolean): void;
}
export {};
